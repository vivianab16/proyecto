...
class EmpleadosControllerTest < ActionController::TestCase
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post :create, empleado: { apellidos: @empleado.apellidos, cargo_id: @empleado.cargo_id, identificacion: @empleado.identificacion, mail: @empleado.mail, nombre: @empleado.nombre, tel: @empleado.tel }
    end
  ...
  test "should update empleado" do
    patch :update, id: @empleado, empleado: { apellidos: @empleado.apellidos, cargo_id: @empleado.cargo_id, identificacion: @empleado.identificacion, mail: @empleado.mail, nombre: @empleado.nombre, tel: @empleado.tel }
    assert_redirected_to empleado_path(assigns(:empleado))
  end
