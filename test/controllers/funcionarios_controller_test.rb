...
class FuncionariosControllerTest < ActionController::TestCase
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post :create, funcionario: { apellidos: @funcionario.apellidos, centro_id: @funcionario.centro_id, identificacion: @funcionario.identificacion, nombre: @funcionario.nombre, programa_id: @funcionario.programa_id }
    end
  ...
  test "should update funcionario" do
    patch :update, id: @funcionario, funcionario: { apellidos: @funcionario.apellidos, centro_id: @funcionario.centro_id, identificacion: @funcionario.identificacion, nombre: @funcionario.nombre, programa_id: @funcionario.programa_id }
    assert_redirected_to funcionario_path(assigns(:funcionario))
  end
